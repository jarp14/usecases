...
public class AssociationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateAssociation_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Association newElement = UsecasesFactory.eINSTANCE.createAssociation();
