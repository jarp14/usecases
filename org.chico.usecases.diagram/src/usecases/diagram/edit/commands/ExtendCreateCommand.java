...
public class ExtendCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateExtend_4003(getContainer(), getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Extend newElement = UsecasesFactory.eINSTANCE.createExtend();
