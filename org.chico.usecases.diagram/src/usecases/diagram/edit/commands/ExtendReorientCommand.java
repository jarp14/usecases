...
public class ExtendReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canExistExtend_4003(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		UseCasesDiagram container = (UseCasesDiagram) getLink().eContainer();
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canExistExtend_4003(container, getLink(), source,
				getNewTarget());
	}
