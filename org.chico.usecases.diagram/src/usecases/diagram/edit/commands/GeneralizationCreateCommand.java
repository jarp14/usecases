...
public class GeneralizationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateGeneralization_4002(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Generalization newElement = UsecasesFactory.eINSTANCE.createGeneralization();
