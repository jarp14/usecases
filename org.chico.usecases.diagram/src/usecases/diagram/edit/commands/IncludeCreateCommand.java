...
public class IncludeCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	private final UseCasesDiagram container;
	...
	*/
	public boolean canExecute() {
		...
		return UsecasesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateInclude_4004(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Include newElement = UsecasesFactory.eINSTANCE.createInclude();
	...
	* @generated
	*/
	protected void doConfigure(Include newElement, IProgressMonitor monitor, IAdaptable info)
	...
	* @generated
	*/
	public UseCasesDiagram getContainer() {
		return container;
	}
	...
	* @generated
	*/
	private static UseCasesDiagram deduceContainer(EObject source, EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null; element = element.eContainer()) {
			if (element instanceof UseCasesDiagram) {
				return (UseCasesDiagram) element;
			}
		}
		return null;
	}
