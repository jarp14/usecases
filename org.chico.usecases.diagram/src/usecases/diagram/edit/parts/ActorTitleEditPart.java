 ...
 * @generated
 */
public class ActorTitleEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.ActorTitleEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ActorTitleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UsecasesParserProvider.getParser(UsecasesElementTypes.Actor_2002, getParserElement(),
					UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.ActorTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
