 ...
 * @generated
 */
public class ExtendTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.ExtendTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ExtendTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UsecasesParserProvider.getParser(UsecasesElementTypes.Extend_4003, getParserElement(),
					UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.ExtendTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
