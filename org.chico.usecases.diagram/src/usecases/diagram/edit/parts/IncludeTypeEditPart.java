 ...
 * @generated
 */
public class IncludeTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.IncludeTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public IncludeTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UsecasesParserProvider.getParser(UsecasesElementTypes.Include_4004, getParserElement(),
					UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.IncludeTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
