...
import usecases.diagram.edit.policies.UsecasesTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SystemTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SystemTitleEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new UsecasesTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return UsecasesElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UsecasesParserProvider.getParser(UsecasesElementTypes.System_2001, getParserElement(),
					UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.SystemTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, UsecasesEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
