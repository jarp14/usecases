 ...
 * @generated
 */
public class UseCaseTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UseCaseTitleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UsecasesParserProvider.getParser(UsecasesElementTypes.UseCase_3001, getParserElement(),
					UsecasesVisualIDRegistry.getType(usecases.diagram.edit.parts.UseCaseTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
