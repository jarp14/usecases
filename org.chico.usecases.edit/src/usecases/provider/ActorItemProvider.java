...
/**
 * This is the item provider adapter for a {@link usecases.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_title_feature", "_UI_Actor_type"),
				 UsecasesPackage.Literals.ACTOR__TITLE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actor.class)) {
			case UsecasesPackage.ACTOR__TITLE:
