...
/**
 * This is the item provider adapter for a {@link usecases.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseCase_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseCase_title_feature", "_UI_UseCase_type"),
				 UsecasesPackage.Literals.USE_CASE__TITLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((UseCase)object).getTitle();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseCase.class)) {
			case UsecasesPackage.USE_CASE__TITLE:
