...
public class UsecasesAdapterFactory extends AdapterFactoryImpl {
	...
	protected UsecasesSwitch<Adapter> modelSwitch =
		new UsecasesSwitch<Adapter>() {
			@Override
			public Adapter caseUseCasesDiagram(UseCasesDiagram object) {
				return createUseCasesDiagramAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseSystem(usecases.System object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link usecases.UseCasesDiagram <em>Use Cases Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUseCasesDiagramAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link usecases.Link <em>Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link usecases.Association <em>Association</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link usecases.Generalization <em>Generalization</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link usecases.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
